...
import ERC20_ABI from '@one-gogh/contract/abi/erc20ABI.json'
import { TOKEN_ADDR, CONTRACT_ADDR, WEI, GAS_LIMIT, GAS_PRICE, MAX_APPROVAL_VALUE } from '@one-gogh/contract/helper'
